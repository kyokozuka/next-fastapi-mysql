...
from src.infrastructure.db.schema import Base
...
from src.infrastructure.db.model.mixin import TimestampMixin
from src.domain.sample.model.new_sample_model import NewSampleModel
from src.infrastructure.db.model.base_model import BaseDBModel
